...
public class OpenApiConfiguration {
  ...
  private static final Map<String, String> PERMISSIONS = Map.ofEntries(
      ...
      permission("ClinicalDocumentController.put", "section.history.edit + section.prescriptions.edit si prescriptions cambia"),
