...
export const CALCULATOR_INVENTORY = [
  ...
  item(4, 'ecog', 'ECOG / Karnofsky', 'legacy-app-js', APP_JS),
  item(5, 'charlson', 'Charlson comorbidity index', 'legacy-app-js', APP_JS),
  item(6, 'g8-carg', 'G8 / CARG', 'legacy-app-js', APP_JS),
  item(7, 'ipss-shim', 'IPSS / SHIM', 'legacy-app-js', APP_JS),
  item(8, 'damico', 'EAU 2026 — riesgo prostático', 'legacy-app-js', APP_JS),
  item(9, 'capra', 'CAPRA / CAPRA-S', 'legacy-app-js', APP_JS),
  item(10, 'partin', 'Partin tables', 'legacy-app-js', APP_JS),
  item(11, 'nodal-risk', 'Roach nodal / Briganti oficial', 'legacy-app-js', APP_JS),
  item(12, 'mskcc-prostate', 'Nomogramas MSKCC próstata', 'legacy-app-js', APP_JS),
  item(13, 'biopsy-risk', 'PBCG — riesgo antes de biopsia', 'legacy-app-js', APP_JS),
  item(14, 'psa-kinetics', 'PSA-D / PSA doubling time / BCR', 'legacy-app-js', APP_JS),
  item(15, 'chaarted-latitude', 'CHAARTED / LATITUDE', 'legacy-app-js', APP_JS),
  item(16, 'nmibc', 'NMIBC EAU / EORTC / CUETO', 'legacy-app-js', APP_JS),
  item(17, 'cystectomy', 'Post-cistectomía', 'legacy-app-js', APP_JS),
  item(18, 'cisplatin', 'Aptitud para cisplatino y platinum', 'legacy-app-js', APP_JS),
  item(19, 'utuc', 'UTUC — riesgo EAU 2026', 'legacy-app-js', APP_JS),
  item(20, 'renal-complexity', 'RENAL / PADUA', 'legacy-app-js', APP_JS),
  item(21, 'leibovich', 'Leibovich 2003 / UISS localizado', 'legacy-app-js', APP_JS),
  item(22, 'imdc', 'IMDC — carcinoma renal metastásico', 'legacy-app-js', APP_JS),
  item(23, 'igcccg', 'IGCCCG testículo', 'legacy-app-js', APP_JS),

  item(24, 'renal-function-oncology', 'Función renal: Cockcroft–Gault y CKD-EPI 2021', 'oncology-general', GENERAL_JS),
  item(25, 'anc-ctcae-v6', 'Recuento absoluto de neutrófilos — CTCAE v6', 'oncology-general', GENERAL_JS),
  item(26, 'khorana-vte', 'Khorana — riesgo de VTE', 'oncology-general', GENERAL_JS),
  item(27, 'mascc-febrile-neutropenia', 'MASCC — neutropenia febril', 'oncology-general', GENERAL_JS),
  item(28, 'cisne-febrile-neutropenia', 'CISNE — neutropenia febril estable', 'oncology-general', GENERAL_JS),
  item(29, 'palliative-prognostic-index', 'Palliative Prognostic Index — PPI', 'oncology-general', GENERAL_JS),
  item(30, 'bed-eqd2', 'BED y EQD2 del fraccionamiento', 'oncology-general', GENERAL_JS),
  item(31, 'qtc-fridericia', 'QT corregido — Fridericia', 'oncology-general', GENERAL_JS),
  item(32, 'nottingham-prognostic-index', 'Nottingham Prognostic Index — NPI', 'oncology-general', GENERAL_JS),
  item(33, 'residual-cancer-burden-experimental', 'Residual Cancer Burden — RCB experimental', 'oncology-general', GENERAL_JS),
  item(34, 'pepi-breast', 'PEPI — Preoperative Endocrine Prognostic Index', 'oncology-general', GENERAL_JS),
  item(35, 'cts5-breast', 'CTS5 — recurrencia tardía', 'oncology-general', GENERAL_JS),
