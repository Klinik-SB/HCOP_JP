...
export const CALCULATOR_INVENTORY = [
  ...
  item(36, 'monarche-cohort-1', 'monarchE — criterios de cohorte 1', 'oncology-general', GENERAL_JS, 'ported'),
  item(37, 'olympia-cpseg', 'OlympiA y CPS+EG', 'oncology-general', GENERAL_JS, 'ported'),
  ...
  item(44, 'gyne-fagotti', 'Ovario — Fagotti PIV clásico', 'oncology-gynecology', GYNECOLOGY_JS, 'ported'),
  item(45, 'gyne-ago-desktop', 'Ovario recurrente — AGO / DESKTOP III', 'oncology-gynecology', GYNECOLOGY_JS, 'ported'),
